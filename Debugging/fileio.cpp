...
int ReadFile(ElecMap *eMap)
{
    ...
    while(1)
    {
        ...
        eMap->roadRecord[eMap->roadNum].brunch=e_brunch;
        eMap->roadRecord[eMap->roadNum].disclass=e_disclass;
        eMap->roadRecord[eMap->roadNum].flag=e_flag;
