...
int BinarySearch_LinkID(ElecMap *eMap,int key);         //用二叉排序对道路LinkID进行检索
int LinearSearch_RoadName(ElecMap *eMap,char name[]);     //用直接插入排序对路名进行检索
